local handlings = {
	...
	--[585] = {5300, 6400, 2.4, 0, 0.15, -0.3, 55, 1.38, 0.86, 0.5, 5, 238.2, 38.2, 72, 'awd', 'petrol', 76, 0.55, true, 25.2, 1.4, 0.8, 0.9, 0.3, -0.15, 0.5, 0, 0.25, 0.5, 35000, 40002800, 200000, 1, 1, 0},  	
	--[458] = {5300, 6400, 2.4, 0, 0.15, -0.3, 55, 1.38, 0.86, 0.5, 5, 238.2, 38.2, 72, 'awd', 'petrol', 76, 0.55, true, 25.2, 1.4, 0.8, 0.9, 0.3, -0.15, 0.5, 0, 0.25, 0.5, 35000, 40002800, 200000, 1, 1, 0},  	
	...
	--[458] = {7000, 30916.699, 1.5, 0, 0, 0, 90, 0.5, 0.7, 0.46, 5, 170, 6, 30, 'rwd', 'diesel', 8.4, 0.45, true, 27, 1, 0.06, 0, 0.35, -0.15, 0.5, 0, 0.27, 0.35, 40000, 4001, 4, 1, 1, 13},
	...
	[585] = {2600, 4700, 2, 0, 0.15, -0.3, 75, 1.12, 0.82, 0.43, 5, 190, 53, 90, 'awd', 'petrol', 80, 0.6, true, 50, 0.55, 0.15, 0, 0.2, -0.3, 0.5, 0.55, 0.2, 0.67, 35000, 0, 400000, 0, 1, 0}, 
	...
	[458] = {3800, 5000, 2.2, 0, 0.2, 0.15, 75, 0.65, 0.8, 0.52, 5, 191, 15, 50, 'rwd', 'petrol', 8, 0.45, true, 30, 0.9, 0.13, 3, 0.3, -0.1, 0.5, 0.3, 0.2, 0.56, 35000, 40000000, 400000, 0, 1, 0}, 
	--[585] = {3800, 5000, 2.2, 0, 0.2, 0.15, 75, 0.65, 0.8, 0.52, 5, 191, 15, 50, 'awd', 'petrol', 8, 0.45, true, 30, 0.9, 0.13, 3, 0.3, -0.1, 0.5, 0.3, 0.2, 0.56, 35000, 40000000, 400000, 0, 1, 0}, 
...
function loadHandling(veh)
	...
	if handlings[model] then 
		...
		elseif model == 566 then 		 -- GT63S
						setVehicleHandling(veh, "mass", 4300)
						setVehicleHandling(veh, "turnMass", 4150)
						setVehicleHandling(veh, "dragCoeff", 1)
						setVehicleHandling(veh, "centerOfMass", { 0, -0.25, -0.04 } )
						setVehicleHandling(veh, "percentSubmerged", 75)
						setVehicleHandling(veh, "tractionMultiplier", 0.875)
						setVehicleHandling(veh, "tractionLoss", 0.91) --
						setVehicleHandling(veh, "tractionBias", 0.463) --
						setVehicleHandling(veh, "numberOfGears", 5)
						setVehicleHandling(veh, "maxVelocity", 267)       
						setVehicleHandling(veh, "engineAcceleration", 35)
						setVehicleHandling(veh, "engineInertia", 117)
						setVehicleHandling(veh, "driveType", "awd")
						setVehicleHandling(veh, "engineType", "petrol")
						setVehicleHandling(veh, "brakeDeceleration", 180)
						setVehicleHandling(veh, "collisionDamageMultiplier", 0.593)
						setVehicleHandling(veh, "brakeBias", 1.2)
						setVehicleHandling(veh, "ABS", true)
						setVehicleHandling(veh, "steeringLock", 55)
						setVehicleHandling(veh, "suspensionHighSpeedDamping", 0.1)	
