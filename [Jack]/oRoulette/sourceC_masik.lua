...
local fieldPositions = {
	{"0", respc(230), blockPosition[2], respc(30), respc(130)},
...
function renderTheRoulette()
	...
	centeredText("Jelenlegi:"..hex.." " ..mySlotCoins.. " #ffffffCoin",panelPosX+respc(180),panelPosY+respc(322),panelWidth,respc(30),tocolor(255,255,255),0.7,Roboto,true,true)
